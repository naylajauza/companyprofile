...
<main>
    ...
    <!-- page title end -->
            ...
            <section class="checkout-section pt-110 pb-100">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="woocommerce">
                                ...
                                <form method="post" class="login" >
                                    ...
                                    <p class="form-row">
                                        ...
                                        <input type="submit" class="thm-btn" name="login" value="Login" />
                                ...
                                <form class="checkout_coupon" method="post">
                                    ...
                                    <p class="form-row form-row-last">
                                        <input type="submit" class="thm-btn" name="apply_coupon" value="Apply Coupon" />
                                    </p>
                                    <div class="clear"></div>
                                </form>
                                    ...
                                    <div id="order_review" class="woocommerce-checkout-review-order">
                                        ...
                                        <div id="payment" class="woocommerce-checkout-payment">
                                            <ul class="wc_payment_methods payment_methods methods">
                                                ...
                                                <li class="wc_payment_method payment_method_paypal">
                                                    ...
                                                    <label for="payment_method_paypal">
                                                        PayPal <img src="assets/img/shop/paypal.png" alt="PayPal Acceptance Mark" /><a href="#!" class="about_paypal" title="What is PayPal?">What is PayPal?</a> </label>
                                            ...
                                            <div class="form-row place-order mt-20">
                                                ...
                                                <input type="submit" class="thm-btn alt" name="woocommerce_checkout_place_order" id="place_order" value="Place order" data-value="Place order" />
