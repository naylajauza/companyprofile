...
<main>
    ...
    <!-- start cart-section -->
    <section class="cart-section woocommerce-cart pt-120 pb-120">
        <div class="container">
            <div class="row">
                                ...
                                <tbody>
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="">
                                                <img width="57" height="70" src="assets/img/shop/img-1.jpg"
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="">
                                                <img width="57" height="70" src="assets/img/shop/img-2.jpg"
                                            class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="#!"  />
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="6" class="actions">
                                            ...
                                            <input type="submit" class="thm-btn" name="update_cart" value="Update Cart" />
                        ...
                        <div class="cart-collaterals">
                            <div class="cart_totals calculated_shipping">
                                ...
                                <div class="wc-proceed-to-checkout">
                                    <a href="#!" class="checkout-button thm-btn alt wc-forward">Proceed to Checkout</a>
                                </div>
                            </div>
                        </div>
                    </div>
